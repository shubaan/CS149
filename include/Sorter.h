...
* parameters are the list of processes, according to Num_PROCESS. The input num decides what field to sort by 0 - arrival time; 1 - service time; 2 - priority; 3 - actual start time; 4 - end time
*/
